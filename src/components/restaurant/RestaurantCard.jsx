    ...
    <div className="restaurant-card">
      <div className="restaurant-image-wrap">
        <Link to={`/restaurants/${restaurant.id}`} className="restaurant-image-link">
          <img src={imgSrc} alt={`${restaurant.name} photo`} className={`restaurant-image-img ${imgSrc === Placeholder ? 'placeholder' : ''}`} loading="lazy" />
        </Link>
        <button
        ...
        >
          {fav ? (
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
